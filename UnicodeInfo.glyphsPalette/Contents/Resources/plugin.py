...
class UnicodeInfoPalette (PalettePlugin, UnicodeInfoWindow):
	...
	def settings(self):
		...
		y = 0
		self.w.block_label = TextBox((10, y, -10, 20), 'Block:', sizeStyle='small')
		y += 17
		self.w.block_list = PopUpButton((10, y, -30, 20), [], sizeStyle='small', callback=self.selectBlock)
		self.w.block_status = CheckBox((-20, y, -10, 20), '', sizeStyle="small")
		if orth_present:
			y += 24
			self.w.orthography_label = TextBox((10, y, -10, 20), 'Usage:', sizeStyle='small')
			y += 17
			self.w.orthography_list = PopUpButton((10, y, -30, 20), [], sizeStyle='small', callback=self.selectOrthography)
			self.w.orthography_status = CheckBox((-20, y, -10, 20), '', sizeStyle="small")
